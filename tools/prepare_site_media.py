...
def main() -> None:
    ...
    for doc_id, relative, pages, drawing_page in DOCUMENTS:
        ...
        for index, page in enumerate(pages, start=1):
            labels = ["cover", "summary", "parameters", "product-photo"]
            label = labels[index - 1] if index <= len(labels) else f"page-{page}"
            target = MEDIA / "evidence" / f"{doc_id}-{label}.webp"
    ...
    gallery_sources = {
        "power-transformer-110kv-50mva.webp": "power-transformer-50mva-110kv-product-photo.webp",
        "power-transformer-132kv-150mva.webp": "power-transformer-150mva-132kv-product-photo.webp",
        "power-transformer-220kv-240mva-ssz20.webp": "power-transformer-240mva-220kv-ssz20-product-photo.webp",
        "power-transformer-220kv-240mva-ssz22.webp": "power-transformer-240mva-220kv-ssz22-product-photo.webp",
        "dry-type-transformer-scb18-1000.webp": "dry-type-scb18-1000kva-10kv-product-photo.webp",
        "dry-type-transformer-scb18-2500.webp": "dry-type-scb18-2500kva-10kv-product-photo.webp",
    }
