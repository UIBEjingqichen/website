...
function homeLandscape() {
  const items = [
    ["company/factory-campus-panorama.jpeg", "Tianyu Electric manufacturing campus"],
    ["applications/grid-substation-yard.jpeg", "Substation and transmission equipment"],
    ["applications/renewable-wind-solar-landscape.jpeg", "Renewable energy project application"],
    ["products/distribution-transformers/oil-immersed-distribution-transformer-conservator-01.webp", "Oil-immersed distribution transformer"],
