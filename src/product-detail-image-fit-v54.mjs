...
if (!finalCss.includes(marker) || !finalCss.includes("object-fit:contain!important") || !finalCss.includes("width:auto!important") || !finalCss.includes("height:auto!important")) throw new Error("v54: intrinsic-ratio complete-image fit rules missing");
if (detailCount < 20) throw new Error(`v54: expected at least 20 detail pages, found ${detailCount}`);

console.log(`v54 detail presentation: intrinsic-ratio contain fit applied across ${detailCount} product pages; no detail image is forced to fill a landscape frame.`);
