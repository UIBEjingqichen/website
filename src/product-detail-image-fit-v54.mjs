...
console.log(`v54 detail presentation: complete-image contain fit applied across ${detailCount} product pages; oil-distribution hero simplified and 22 kV retained only inside the technical range.`);
