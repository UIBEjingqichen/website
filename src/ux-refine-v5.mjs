...
function familyMain(product) {
  ...
  const applicationImages = ["hero-home-substation-grid.jpeg", "case-renewable-energy-base.jpeg", "products/oil-distribution-transformer-02.webp", "case-offshore-wind-project.jpeg"];
...
function whyChooseUs() {
  return `<section class="section yw-why v5-why" id="why-us"><div class="yw-centered-head light"><p>WHY CHOOSE US</p><h2>ENGINEERING CONFIDENCE YOU CAN REVIEW</h2><div class="v5-why-links"><a href="applications.html">VIEW CASES →</a><a href="manufacturing.html">VIEW MANUFACTURING →</a></div></div>
    ...
    <div class="v5-proof-grid"><a class="v5-proof-card" href="applications.html"><div class="v5-proof-image"><img src="${media("case-renewable-energy-base.jpeg")}" alt="Tianyu Electric project reference" loading="lazy"></div><div><p>PROJECT CASES</p><h3>From renewable energy to utility and industrial power projects</h3><span>Explore recorded project references by application and product family.</span><strong>VIEW CASES →</strong></div></a><a class="v5-proof-card" href="manufacturing.html"><div class="v5-proof-image"><img src="${media("company-factory-campus.jpeg")}" alt="Tianyu Electric manufacturing base" loading="lazy"></div><div><p>MANUFACTURING</p><h3>Production, assembly, testing and quality control in one workflow</h3><span>Review the manufacturing base and the equipment behind project delivery.</span><strong>VIEW MANUFACTURING →</strong></div></a></div>
  </section>`;
}
