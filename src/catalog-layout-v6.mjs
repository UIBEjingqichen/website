...
const productConfig = [
  {
    ...
    images: [
      ["assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-conservator-01.webp", "Oil-immersed distribution transformer"],
      ["assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-sealed-01.webp", "Oil-immersed distribution transformer product view"]
    ],
    overview: [
  ...
  },
  {
    ...
    images: [
      ["assets/media/evidence/sample-photo-pages/power-transformer-240mva-220kv-ssz22-sample-photo-page.webp", "240 MVA 220 kV power transformer"],
      ["assets/media/evidence/sample-photo-pages/power-transformer-150mva-132kv-sample-photo-page.webp", "150 MVA 132 kV power transformer"]
    ],
    overview: [
  ...
  },
  {
    ...
    images: [
      ["assets/media/evidence/sample-photo-pages/dry-type-scb18-2500kva-10kv-sample-photo-page.webp", "SCB18 2500 kVA cast-resin dry-type transformer"],
      ["assets/media/evidence/sample-photo-pages/dry-type-scb18-1000kva-10kv-sample-photo-page.webp", "SCB18 1000 kVA cast-resin dry-type transformer"]
    ],
    overview: [
  ...
  },
  {
    ...
    images: [
      ["assets/media/products/prefabricated-substations/dry-type-prefabricated-substation-exterior-01.webp", "European-type prefabricated substation"],
      ["assets/media/applications/wind-turbine-dry-type-prefabricated-substation-site.webp", "Prefabricated substation for renewable-energy applications"]
    ],
    overview: [
  ...
  },
  {
    ...
    images: [
      ["assets/media/products/prefabricated-substations/oil-prefabricated-substation-exterior-01.webp", "Compact prefabricated substation"],
      ["assets/media/products/prefabricated-substations/oil-prefabricated-substation-lv-cabinet-interior.webp", "Oil-immersed prefabricated substation project configuration"]
    ],
    overview: [
  ...
  },
  {
    ...
    images: [
      ["assets/media/products/combined-transformers/american-type-combined-transformer-exterior-01.webp", "Pad-mounted transformer"],
      ["assets/media/products/combined-transformers/american-type-combined-transformer-lv-cabinet-interior.webp", "Renewable-energy combined transformer"]
    ],
    overview: [
