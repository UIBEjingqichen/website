...
const overview = `<section class="catalog-sheet product-overview-sheet catalog-v9-overview" id="product-oil-immersed-distribution-transformer">
  ...
  <div class="v9-overview-stage">
    <div class="catalog-product-photo-pair catalog-photo-count-3 v9-product-gallery">
      <figure><img src="assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-conservator-01.webp" alt="Oil-immersed distribution transformer" loading="lazy"></figure>
      <figure><img src="assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-sealed-01.webp" alt="Oil-immersed distribution transformer product view" loading="lazy"></figure>
      <figure><img src="assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-cable-connected-01.webp" alt="Oil-immersed distribution transformer internal and component view" loading="lazy"></figure>
    </div>
...
const details = `<section class="catalog-sheet product-evidence-sheet catalog-product-detail-sheet catalog-product-spec-sheet catalog-v9-details">
  ...
  <div class="v9-details-stage">
    ...
    <aside class="v9-reference-panel">
      <figure><img src="assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-sealed-01.webp" alt="Oil-immersed distribution transformer reference product" loading="lazy"></figure>
