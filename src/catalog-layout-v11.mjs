...
replaceOverview("product-high-voltage-power-transformer", makeOverview({
  ...
  images: [["assets/media/product-oil-immersed-power-transformer.png", "High-voltage power transformer"], ["assets/media/product-oil-immersed-energy-saving-transformer.jpeg", "Oil-immersed power transformer"]], galleryClass: "v11-gallery-2",
...
replaceDetails("High-Voltage Power Transformer", makeDetails({
  ...
  ], strip:[["Voltage class","Up to 220 kV"],["Reference capacity","Up to 240 MVA tested"],["Cooling","ONAN / ONAF"],["Frequency","50 Hz"]], image:"assets/media/product-oil-immersed-power-transformer.png",
...
replaceOverview("product-cast-resin-dry-type-transformer", makeOverview({
  ...
  images:[["assets/media/product-dry-type-transformer-red.jpeg","SCB18 cast-resin dry-type transformer"],["assets/media/product-cast-resin-dry-type-transformer.jpeg","Cast-resin dry-type transformer"]],galleryClass:"v11-gallery-2",
...
replaceOverview("product-dry-type-prefabricated-substation", makeOverview({
  ...
  images:[["assets/media/products/dry-type-prefabricated-substation-01.webp","European-type prefabricated substation"],["assets/media/products/dry-type-prefabricated-substation-03.webp","Prefabricated substation outdoor view"],["assets/media/products/dry-type-prefabricated-substation-02.webp","Prefabricated substation project view"],["assets/media/products/dry-type-prefabricated-substation-04.webp","Prefabricated substation supporting view"]],galleryClass:"v11-gallery-4",
...
replaceOverview("product-oil-immersed-prefabricated-substation", makeOverview({
  ...
  images:[["assets/media/products/oil-prefabricated-substation-01.webp","Compact prefabricated substation"],["assets/media/products/oil-prefabricated-substation-04.webp","Compact substation project view"],["assets/media/products/oil-prefabricated-substation-02.webp","Compact substation supporting view"],["assets/media/products/oil-prefabricated-substation-03.webp","Compact substation additional view"]],galleryClass:"v11-gallery-4",
...
replaceOverview("product-american-type-combined-transformer", makeOverview({
  ...
  images:[["assets/media/products/american-combined-transformer-01.webp","Pad-mounted combined transformer"],["assets/media/products/american-combined-transformer-04.webp","Combined transformer renewable-energy configuration"],["assets/media/products/american-combined-transformer-02.webp","Pad-mounted transformer supporting view"],["assets/media/products/american-combined-transformer-03.webp","Pad-mounted transformer additional view"]],galleryClass:"v11-gallery-4",
...
replaceDetails("Pad-Mounted Transformer", makeDetails({
  ...
  strip:[["Reference voltage","37 / 0.8 kV"],["Tested capacity","4000 kVA"],["Cooling","ONAN"],["Vector group","Dy11"]],image:"assets/media/products/american-combined-transformer-01.webp",models:[["ZGS22-4000/35/0.8","4000 kVA · 37 / 0.8 kV"]],evidence:["24XB0336-S","Short-circuit · impulse · IP · temperature-rise · sound"]
}));
