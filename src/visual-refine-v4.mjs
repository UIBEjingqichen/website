...
function heroWave() {
  const slides = [
    ...
    ["company-factory-campus.jpeg", "MANUFACTURING, TESTING & DOCUMENT CONTROL", "Integrated production, inspection and export document support from one factory base."],
    ["case-renewable-energy-base.jpeg", "SERVING UTILITY, RENEWABLE & INDUSTRIAL PROJECTS", "Reference coverage across utility grids, renewable energy, infrastructure and industrial power systems."]
  ];
