...
const main = `<main>
  ...
  <section class="ab30-overview" id="company-overview"><div class="ab30-shell">
    ...
    <div class="ab30-metrics">
      <div class="ab30-metric"><small>Transformer platform</small><strong>220 kV</strong><span>Power-transformer capability</span></div>
      <div class="ab30-metric"><small>Product portfolio</small><strong>30+</strong><span>Product series</span></div>
      <div class="ab30-metric"><small>Manufacturing base</small><strong>85,243 m²</strong><span>Plant area</span></div>
      <div class="ab30-metric"><small>Production equipment</small><strong>460</strong><span>Large mechanical equipment</span></div>
    </div>
  </div></section>
