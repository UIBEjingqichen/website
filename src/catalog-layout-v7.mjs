...
html = html
  .replaceAll("assets/media/evidence/sample-photo-pages/power-transformer-240mva-220kv-ssz22-sample-photo-page.webp", "assets/media/products/power-transformers/oil-immersed-power-transformer-installed.png")
  .replaceAll("assets/media/evidence/sample-photo-pages/power-transformer-150mva-132kv-sample-photo-page.webp", "assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-green.jpeg")
  .replaceAll("assets/media/evidence/sample-photo-pages/dry-type-scb18-2500kva-10kv-sample-photo-page.webp", "assets/media/products/dry-type-transformers/cast-resin-dry-type-transformer-red-01.jpeg")
  .replaceAll("assets/media/evidence/sample-photo-pages/dry-type-scb18-1000kva-10kv-sample-photo-page.webp", "assets/media/products/dry-type-transformers/cast-resin-transformer-core-coil-assembly.jpeg")
  .replaceAll(
...
const galleryRules = new Map([
  ["product-oil-immersed-distribution-transformer", ["assets/media/products/distribution-transformers/oil-immersed-distribution-transformer-cable-connected-01.webp"]],
  ["product-high-voltage-power-transformer", []],
  ["product-cast-resin-dry-type-transformer", []],
  ["product-dry-type-prefabricated-substation", ["assets/media/products/prefabricated-substations/dry-type-prefabricated-substation-lineup.webp", "assets/media/factory/dry-type-prefabricated-substation-assembly-01.webp"]],
  ["product-oil-immersed-prefabricated-substation", ["assets/media/applications/industrial-platform-oil-prefabricated-substation-site.webp", "assets/media/applications/oil-prefabricated-substation-site-01.webp"]],
  ["product-american-type-combined-transformer", ["assets/media/products/combined-transformers/american-type-combined-transformer-exterior-02.webp", "assets/media/applications/floating-solar-combined-transformer-site.webp"]]
]);
